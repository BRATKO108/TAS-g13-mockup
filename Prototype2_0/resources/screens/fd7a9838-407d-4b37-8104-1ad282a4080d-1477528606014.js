jQuery("#simulation")
  .on("click", ".s-fd7a9838-407d-4b37-8104-1ad282a4080d .click", function(event, data) {
              ...
              "actions": [
                {
                  "action": "jimNavigation",
                  "parameter": {
                    "target": "screens/1ffeeaa7-fdff-4e2d-90d5-5d06477b34b3"
                  },
                  "exectype": "serial",
                  "delay": 0
                }
  ...
  .on("pageload", ".s-fd7a9838-407d-4b37-8104-1ad282a4080d .pageload", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
